        ...
        <div class="card shadow-sm border-bottom-success">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="id_barang_keluar">ID Transaksi Barang Keluar</label>
                    <div class="col-md-10">
                ...
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="barang_id">Barang</label>
                    <div class="col-md-10">
                ...
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="stok">Stok</label>
                    <div class="col-md-10">
                        <input readonly="readonly" id="stok" type="number" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="jumlah_keluar">Jumlah Keluar</label>
                    <div class="col-md-10">
                        <div class="input-group">
                            <input autocomplete="off" value="<?= set_value('jumlah_keluar'); ?>" name="jumlah_keluar" id="jumlah_keluar" type="number" class="form-control" placeholder="Jumlah Keluar">
                            <div class="input-group-append">
                ...
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="total_stok">Total Stok</label>
                    <div class="col-md-10">
