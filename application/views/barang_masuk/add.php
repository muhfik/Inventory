        ...
        <div class="card shadow-sm border-bottom-success">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="id_barang_masuk">ID Transaksi Barang Masuk</label>
                    <div class="col-md-10">
                ...
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="jumlah_masuk">Jumlah Masuk</label>
                    <div class="col-md-10">
                        <div class="input-group">
                            <input autocomplete="off" value="<?= set_value('jumlah_masuk'); ?>" name="jumlah_masuk" id="jumlah_masuk" type="number" class="form-control" placeholder="Jumlah Masuk">
                            <div class="input-group-append">
