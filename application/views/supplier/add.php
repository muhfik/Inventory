                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <input autocomplete="off" value="<?= set_value('nama_supplier'); ?>" name="nama_supplier" id="nama_supplier" type="text" class="form-control" placeholder="Nama Supplier">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <input autocomplete="off" value="<?= set_value('no_telp'); ?>" name="no_telp" id="no_telp" type="text" class="form-control" placeholder="Nomor Telepon">
                        </div>
