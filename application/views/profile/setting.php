    ...
    <div class="col-md-12">
        <div class="card shadow-sm border-bottom-success">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <input autocomplete="off" value="<?= set_value('username', $user['username']); ?>" name="username" id="username" type="text" class="form-control" placeholder="Username">
                        </div>
                ...
                <hr>
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="nama">Nama Anda</label>
                    <div class="col-md-10">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-user"></i></span>
                            </div>
                            <input autocomplete="off" value="<?= set_value('nama', $user['nama']); ?>" name="nama" id="nama" type="text" class="form-control" placeholder="Nama Anda">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <input autocomplete="off" value="<?= set_value('email', $user['email']); ?>" name="email" id="email" type="text" class="form-control" placeholder="Email">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <input autocomplete="off" value="<?= set_value('no_telp', $user['no_telp']); ?>" name="no_telp" id="no_telp" type="text" class="form-control" placeholder="Nomor Telepon">
                        </div>
