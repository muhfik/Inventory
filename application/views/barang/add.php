        ...
        <div class="card shadow-sm border-bottom-success">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <input autocomplete="off" value="<?= set_value('nama_barang'); ?>" name="nama_barang" id="nama_barang" type="text" class="form-control" placeholder="Nama Barang">
                        <?= form_error('nama_barang', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="koordinat_id">Titik Kordinat</label>
                    <div class="col-md-10">
                        <div class="input-group">
                            <select name="koordinat_id" id="koordinat_id" class="custom-select">
                                <option value="" selected disabled>Pilih Titik Kordinat</option>
                                <?php foreach ($koordinat as $j) : ?>
                                    <option <?= set_select('koordinat_id', $j['id_koordinat']) ?> value="<?= $j['id_koordinat'] ?>"><?= $j['koordinat'] ?></option>
                                <?php endforeach; ?>
                            </select>
