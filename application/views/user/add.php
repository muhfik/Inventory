        ...
        <div class="card shadow-sm mb-4 border-bottom-success">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="username">Username</label>
                    <div class="col-md-10">
                        <input autocomplete="off" value="<?= set_value('username'); ?>" type="text" id="username" name="username" class="form-control" placeholder="Username">
                        <?= form_error('username', '<span class="text-danger small">', '</span>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="password">Password</label>
                    <div class="col-md-10">
                ...
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="password2">Konfirmasi Password</label>
                    <div class="col-md-10">
                        <input autocomplete="off" type="password" id="password2" name="password2" class="form-control" placeholder="Konfirmasi Password">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <input autocomplete="off" value="<?= set_value('nama'); ?>" type="text" id="nama" name="nama" class="form-control" placeholder="Nama">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <input autocomplete="off" value="<?= set_value('email'); ?>" type="text" id="email" name="email" class="form-control" placeholder="Email">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <input autocomplete="off" value="<?= set_value('no_telp'); ?>" type="text" id="no_telp" name="no_telp" class="form-control" placeholder="Nomor Telepon">
                        <?= form_error('no_telp', '<span class="text-danger small">', '</span>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="role">Role</label>
                    <div class="col-md-10">
