        ...
        <div class="card shadow-sm mb-4 border-bottom-success">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <input autocomplete="off" value="<?= set_value('username', $user['username']); ?>" type="text" id="username" name="username" class="form-control" placeholder="Username">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <input autocomplete="off" value="<?= set_value('nama', $user['nama']); ?>" type="text" id="nama" name="nama" class="form-control" placeholder="Nama">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <input autocomplete="off" value="<?= set_value('email', $user['email']); ?>" type="text" id="email" name="email" class="form-control" placeholder="Email">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <input autocomplete="off" value="<?= set_value('no_telp', $user['no_telp']); ?>" type="text" id="no_telp" name="no_telp" class="form-control" placeholder="Nomor Telepon">
