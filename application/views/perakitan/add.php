    ...
    <div class="col-md-12">
        <div class="card shadow-sm border-bottom-success">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="komponen">Komponen</label>
                    <div class="col-md-10">
                        <textarea name="komponen" id="komponen" class="form-control" rows="4" placeholder="Komponen"><?= set_value('komponen'); ?></textarea>
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-success" href="<?= base_url('barang_keluar/add'); ?>"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                ...
                <div class="row form-group">
                    <label class="col-md-2 text-md-right" for="user_id">Anggota</label>
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-success" href="<?= base_url('user/add'); ?>"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
